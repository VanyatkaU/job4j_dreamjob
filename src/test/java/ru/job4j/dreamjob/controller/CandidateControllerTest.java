...
class CandidateControllerTest {
    ...
    @Test
    public void whenRequestIdOfCandidateThenRedirectToCandidateOnePage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
    ...
    @Test
    public void whenRequestIdOfCandidateThenRedirectToErrorPage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
    ...
    @Test
    public void whenPostUpdateVacancyThenRedirectToErrorPage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
        when(candidateService.update(candidateArgumentCaptor.capture(),
    ...
    @Test
    public void whenRequestDeleteCandidateByIdThenGetUpdateCandidatesPage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
    ...
    @Test
    public void whenRequestDeleteCandidateByIdThenGetErrorPage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        when(candidateService.deleteById(candidate.getId())).thenReturn(false);
