...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestIdOfVacancyThenRedirectToVacancyOnePage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenRequestIdOfVacancyThenRedirectToErrorPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenRequestDeleteVacancyByIdThenGetUpdateVacanciesPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenRequestDeleteVacancyByIdThenGetErrorPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        when(vacancyService.deleteById(vacancy.getId())).thenReturn(false);
